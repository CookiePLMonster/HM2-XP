...
class CHM2Direct3DDevice9Ex : public IDirect3DDevice9Ex
{
public:
	...
	virtual HRESULT STDMETHODCALLTYPE MultiplyTransform(D3DTRANSFORMSTATETYPE Transform,CONST D3DMATRIX* pMatrix);
...
public:
	CHM2Direct3DDevice9Ex(IDirect3D9* pCreator, UINT Adapter, D3DDEVTYPE DeviceType, HWND hFocusWindow, DWORD BehaviorFlags, D3DPRESENT_PARAMETERS* pPresentationParameters);
	virtual ~CHM2Direct3DDevice9Ex();

private:
	unsigned int			nRefcount;
	IDirect3DDevice9*		pWrappedInterface;
};